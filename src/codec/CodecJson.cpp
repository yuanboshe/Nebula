...
#include "CodecJson.hpp"

namespace neb
{

CodecJson::CodecJson(std::shared_ptr<NetLogger> pLogger, E_CODEC_TYPE eCodecType)
...
E_CODEC_STATUS CodecJson::Encode(const MsgHead& oMsgHead, const MsgBody& oMsgBody, CBuffer* pBuff)
{
...
E_CODEC_STATUS CodecJson::Decode(CBuffer* pBuff, MsgHead& oMsgHead, MsgBody& oMsgBody)
{
